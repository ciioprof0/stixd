...
Various genitive constructs can optionally be attached to a noun phrase: _of_
...
Declarative sentences are simple sentences, _there is/are_ -sentences, boolean
